...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_desc.setText(_translate("Dialog", "<html><head/><body><p>youtube_desc</p></body></html>"))
        self.label_caption.setText(_translate("Dialog", "<html><head/><body><p>tiktok_caption</p></body></html>"))
        self.label_title_tags.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:10pt;\">title_tags</span></p></body></html>"))
        self.label_tags.setText(_translate("Dialog", "<html><head/><body><p>youtube_tags</p></body></html>"))
        self.label_title.setText(_translate("Dialog", "<html><head/><body><p>youtube_title</p></body></html>"))
